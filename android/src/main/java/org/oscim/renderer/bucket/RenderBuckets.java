 ...
 *
 * -----------------------------------------------------------------------------------
 * Default (unmodified) vtm RenderBuckets, restored for vtm 0.28.0 compatibility.
 *
 * vtm 0.28.0 removed this class but MapRenderer still references it.  This is
 * the original implementation with VERTEX_CNT[LINE] = 4 (standard vertex
 * format).  Extensions that shadow this class (e.g. path-color-ramp) provide
 * modified versions via strip-vtm-classes.gradle.
 */
