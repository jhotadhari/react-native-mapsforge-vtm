...
- Added props `enabledZoomMin` and `enabledZoomMax` to `LayerBitmapTile`, `LayerMBTilesBitmap` and `LayerMapsforge` components.
...
[Unreleased]: https://github.com/jhotadhari/react-native-mapsforge-vtm/compare/v0.3.0...HEAD
